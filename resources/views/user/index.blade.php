                                        ...
                                        @forelse ($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#"
                                                    class="btn btn-light btn-sm rounded shadow-sm border p-0 m-0 delete"
                                                    ...
                                                    <form id="deleteForm" action="{{ route('user.destroy', ['user' => $user->id]) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                    <a class="btn btn-light btn-sm rounded shadow-sm border p-0 m-0"
        ...
        function confirmDelete(userId, userName) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // Menggunakan fetch untuk mengirimkan request ke server
                    fetch(form.action, {
                        method: 'POST',
                        body: formData,
                    })
                    ...
                    .then(data => {
                        ...
                        if (data.status === 'success') {
                            Swal.fire({
                                ...
                                // Reload page or remove the user from the list
